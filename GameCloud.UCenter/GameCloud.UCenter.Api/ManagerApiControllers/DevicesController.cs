...
namespace GameCloud.UCenter.Api.ManagerApiControllers
{
    ...
    public class DevicesController : ManagerApiControllerBase
    {
        ...
        public async Task<PluginPaginationResponse<DeviceEntity>> Post([FromBody]PluginRequestInfo request, CancellationToken token)
        {
            ...
            var total = await this.UCenterDatabase.Devices.CountAsync(filter, null, token);
